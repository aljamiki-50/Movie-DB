...
<body class= ' font-sans bg-gray-900 text-white'>
    ...
    <nav class="border-b text-center  border-gray-800 px-10">
        <div class="container mx-auto flex items-center justify-between px-4 py-6 ">
            <ul class="flex items-center text-slate-300">
                <li class="">
                ...
                <li class="ml-6">
                    <a href="{{ route('tv.index') }}" class="hover:text-gray-300 ">TvShows</a>
                </li>
                <li class="ml-6">
                    <a href="{{ route('actors') }}" class="  hover:text-gray-300">Actors</a>
                </li>
            </ul>
            <div class="flex items-center animate-bounce text-center ">
                @livewire('search-drop-down')
                <div class="ml-4 box-border  text-center pt-2 ">
                    <a href="" class="text-center  "><img src="/img/liam.png"
                            class=" rounded-full w-8  h-8 bg-slate-200" alt="avatar"></a>
