...
@section('content')
    <div class="movie-info border-b box-border container mx-auto border-gray-800 ">
        <div class="container mx-auto px-32 py-16 box-border   grid  grid-cols-2 ">
            <div> <img src="{{ $actor['profile_path'] }}" class=" hover:opacity-75   transition-all duration-150 w-96"
                    alt="">
                <div class="flex items-center gap-6   mt-4">
                    @if ($social['facebook'])
                        <li class="  list-none"><a href="{{ $social['facebook'] }}" title="facebook"> <svg
                    ...
                    @if ($social['instagram'])
                        <li class="  list-none"><a href="{{ $social['instagram'] }}" title="instgram">
                    ...
                    @endif
                    @if ($actor['homepage'])
                        <li class="  list-none"><a href="{{ $actor['homepage'] }}" title="Social">
            ...
            <div class="  over  box-border ">
                ...
                <div class="flex  items-center mt-2 text-gray-400">
                    <span> <svg class="fill-current text-gray-400 hover:text-white w-4" viewBox="0 0 448 512">
                            <path
                    ...
                    <span class="ml-2">{{ $actor['birthday'] }}@if ($actor['age'])
                            ({{ $actor['age'] . ' ' . 'Y.O' }})
                        @else
                            null
                        @endif {{ $actor['place_of_birth'] }}</span>



                </div>

                {{-- start of know for part with 5 top-shows to show  --}}
                <div class="flex  flex-wrap">
                    ...
                    <h2 class="mt-12  font-semibold tracking-wider  text-lg">known for </h2>
                    <div class="grid font-semibold text-sm   grid-cols-5 ">
                        @foreach ($knownForMovies as $movie)
                            <div class=" ml-2  mt-4 flex flex-col gap-y-6">
                                <a href="{{ $movie['linkToPage'] }}"><img src="{{ $movie['poster_path'] }}" alt="poster"
                                        class="hover:opacity-75 transition ease-in-out duration-150 touch-pan-x"></a>
    ...
    <div class="c redits border-b box-border border-gray-800" x-data="{ isOpen: false, image: '' }">
        <div class="container  mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold uppercase ">credits</h2>

            <ul class="  list-disc leading-loose  pl-5 pt-8">
    ...
    {{-- endign of img credit line  --}}
    {{-- ending of img credit line  --}}
@endsection
